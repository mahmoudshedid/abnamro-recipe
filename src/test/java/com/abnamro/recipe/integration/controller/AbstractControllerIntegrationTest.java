...
import com.abnamro.recipe.RecipeTestApplication;
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = RecipeTestApplication.class)
